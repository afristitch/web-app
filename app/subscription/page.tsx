...
function SubscriptionContent() {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-black">
                <div className="flex flex-col items-center gap-4 text-stone-400">
                    ...
                    <p className="text-sm font-medium tracking-wider uppercase text-stone-500">Loading Account Details...</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <main className="min-h-screen pt-32 pb-28 bg-black text-white">
            <SectionWrapper>
                <div className="container mx-auto max-w-7xl px-6">
                        ...
                        <div className="flex items-center gap-4">
                            {user.photoUrl && (user.photoUrl.startsWith("http://") || user.photoUrl.startsWith("https://")) ? (
                                <Image
                                    ...
                                    width={64}
                                    height={64}
                                    className="w-16 h-16 rounded-full object-cover border-2 border-white/20 shrink-0 shadow-2xl"
                                    unoptimized
                                />
                            ) : (
                                <div className="w-16 h-16 rounded-full bg-[#FDDA0D] text-black font-extrabold text-2xl flex items-center justify-center shrink-0 uppercase shadow-2xl">
                    ...
                    {/* Alert Notices */}
                    {paymentSuccessMsg && (
                        <div className="mb-8 p-4 rounded-2xl bg-emerald-950/60 border border-emerald-500/30 text-emerald-300 text-sm flex items-center gap-3 animate-in fade-in">
                    ...
                    {errorMsg && (
                        <div className="mb-8 p-4 rounded-2xl bg-red-950/60 border border-red-500/30 text-red-300 text-sm flex items-center gap-3 animate-in fade-in">
                    ...
                    <div className="mb-16 p-8 md:p-10 rounded-3xl bg-stone-950/90 border border-white/10 backdrop-blur-xl relative overflow-hidden shadow-2xl">
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                            <div>
                                <div className="text-xs font-bold uppercase tracking-widest text-stone-500 mb-2" style={{ fontFamily: "var(--font-varela-round)" }}>
                            ...
                            {subStatus?.isPremium ? (
                                <div className="md:text-right border-t md:border-t-0 md:border-l border-white/10 pt-4 md:pt-0 md:pl-8 flex flex-col justify-center shrink-0">
                                    ...
                                    <div className="text-4xl font-extrabold text-white">
                                        ...
                                        <span className="text-stone-500 text-base font-normal">days</span>
                                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                        {DURATION_OPTIONS.map((opt) => {
                            ...
                            return (
                                ...
                                >
                                    {opt.isPopular && (
                                        <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-4 py-1 bg-white text-black text-[11px] font-bold rounded-full tracking-wider uppercase shadow-lg">
                                            {opt.tag}
                                        </div>
                                    )}
