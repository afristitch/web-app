            ...
            <SectionWrapper>
                <div className="container mx-auto max-w-4xl px-6 text-center">
                    ...
                    <div className="prose prose-invert prose-stone max-w-none space-y-8 text-stone-400 font-medium">
                        <section>
                            <h2 className="text-xl font-bold text-white uppercase tracking-tight" style={{ fontFamily: 'var(--font-varela-round)' }}>1. Acceptance of Terms</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-white uppercase tracking-tight" style={{ fontFamily: 'var(--font-varela-round)' }}>2. Use License</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-white uppercase tracking-tight" style={{ fontFamily: 'var(--font-varela-round)' }}>3. Disclaimer</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-white uppercase tracking-tight" style={{ fontFamily: 'var(--font-varela-round)' }}>4. Limitations</h2>
