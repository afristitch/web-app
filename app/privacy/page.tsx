            ...
            <SectionWrapper>
                <div className="container mx-auto max-w-4xl px-6">
                    ...
                    <div className="prose prose-invert prose-stone max-w-none space-y-8 text-stone-400 font-medium">
                        <section>
                            <h2 className="text-xl font-bold text-white uppercase tracking-tight" style={{ fontFamily: 'var(--font-termina)' }}>1. Information We Collect</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-white uppercase tracking-tight" style={{ fontFamily: 'var(--font-termina)' }}>2. How We Use Your Information</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-white uppercase tracking-tight" style={{ fontFamily: 'var(--font-termina)' }}>3. Information Sharing</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-white uppercase tracking-tight" style={{ fontFamily: 'var(--font-termina)' }}>4. Data Security</h2>
